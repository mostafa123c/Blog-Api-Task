...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions) {
        $exceptions->renderable(function (Throwable $e, Request $request) {
            return match (true) {
                $e instanceof NotFoundHttpException   => response()->json(['success' => false, 'message' => 'model not found'], 404),
                $e instanceof RouteNotFoundException  => response()->json(['success' => false, 'message' => 'route not found'], 404),
